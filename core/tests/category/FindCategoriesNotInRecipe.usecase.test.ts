...
import FindCategoriesNotInRecipeUsecase from "../../usecases/category/FindCategoriesNotInRecipe.usecase";
...
describe("Get categories not in recipe use case unit tests", () => {
  let getCategoriesNotInRecipeUseCase: FindCategoriesNotInRecipeUsecase;
  ...
  beforeEach(() => {
    ...
    getCategoriesNotInRecipeUseCase = new FindCategoriesNotInRecipeUsecase(
      categoryRepository,
      recipeRepository
    );

...
import FindRecipesByIdCategoryUsecase from "../../usecases/category/FindRecipesByIdCategory.usecase";
...
describe("Get recipes by id category use case unit tests", () => {
  let getRecipesByIdCategoryUseCase: FindRecipesByIdCategoryUsecase;
  ...
  beforeEach(() => {
    ...
    getRecipesByIdCategoryUseCase = new FindRecipesByIdCategoryUsecase(
      categoryRepository
    );

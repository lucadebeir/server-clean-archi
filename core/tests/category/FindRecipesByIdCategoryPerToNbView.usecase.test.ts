...
import FindRecipesByIdCategoryPerToNbViewUsecase
    from "../../usecases/category/FindRecipesByIdCategoryPerToNbView.usecase";
...
describe("Get Recipes by id category use case unit tests", () => {
  let getRecipesByIdCategoryPerToNbViewUseCase: FindRecipesByIdCategoryPerToNbViewUsecase;
  ...
  beforeEach(() => {
    ...
    getRecipesByIdCategoryPerToNbViewUseCase =
      new FindRecipesByIdCategoryPerToNbViewUsecase(categoryRepository);

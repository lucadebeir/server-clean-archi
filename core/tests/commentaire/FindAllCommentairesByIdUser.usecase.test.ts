...
import FindAllCommentairesByIdUserUsecase from "../../usecases/commentaire/FindAllCommentairesByIdUser.usecase";
...
describe("Get all commentaires of an user use case unit tests", () => {
  let getAllCommentairesByIdUserUseCase: FindAllCommentairesByIdUserUsecase;
  ...
  beforeEach(() => {
    ...
    getAllCommentairesByIdUserUseCase = new FindAllCommentairesByIdUserUsecase(

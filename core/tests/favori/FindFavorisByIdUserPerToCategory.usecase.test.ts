...
import FindFavorisByIdUserPerToCategoryUsecase from "../../usecases/favori/FindFavorisByIdUserPerToCategory.usecase";
...
describe("Get favoris by id user per to category use case unit tests", () => {
  let getFavorisByIdUserPerToCategoryUseCase: FindFavorisByIdUserPerToCategoryUsecase;
  ...
  beforeEach(() => {
    ...
    getFavorisByIdUserPerToCategoryUseCase =
      new FindFavorisByIdUserPerToCategoryUsecase(
        favoriRepository,
        categoryRepository
      );

...
import FindIngredientByIdUsecase from "../../usecases/ingredient/FindIngredientById.usecase";
...
describe("get ingredient by id use case unit tests", () => {
  let getIngredientByIdUseCase: FindIngredientByIdUsecase;
  ...
  beforeEach(() => {
    getIngredientByIdUseCase = new FindIngredientByIdUsecase(

...
import FindRecipeByIdUsecase from "../../usecases/recipe/FindRecipeById.usecase";
...
describe("Get recipe by id use case unit tests", () => {
  let getRecipeByIdUseCase: FindRecipeByIdUsecase;
  ...
  beforeEach(() => {
    ...
    getRecipeByIdUseCase = new FindRecipeByIdUsecase(recipeRepository);

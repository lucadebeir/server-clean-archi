...
import FindShoppingListByIdUsecase from "../../usecases/shopping-list/FindShoppingListById.usecase";
...
describe("Get shopping list by pseudo use case unit tests", () => {
  let getShoppingListByIdUseCase: FindShoppingListByIdUsecase;
  ...
  beforeEach(() => {
    ...
    getShoppingListByIdUseCase = new FindShoppingListByIdUsecase(
      shoppingRepository,
      userRepository
    );

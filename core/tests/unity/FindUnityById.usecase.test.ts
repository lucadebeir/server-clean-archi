...
import FindUnityByIdUsecase from "../../usecases/unity/FindUnityById.usecase";
...
describe("get unity by id use case unit tests", () => {
  let getUnityByIdUseCase: FindUnityByIdUsecase;
  ...
  beforeEach(() => {
    getUnityByIdUseCase = new FindUnityByIdUsecase(unityRepository);

...
import FindAllAbonneUsersUsecase from "../../usecases/user/FindAllAbonneUsers.usecase";
...
describe("Get all abonne users use case unit tests", () => {
  let getAllAbonneUsersUseCase: FindAllAbonneUsersUsecase;
  ...
  beforeEach(() => {
    users = initUsers();
    getAllAbonneUsersUseCase = new FindAllAbonneUsersUsecase(userRepository);
